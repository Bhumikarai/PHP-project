                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                         ...
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="file" id="Image" accept=".jpg, .jpeg, .png" name="Image" placeholder="Image" class="span8" required>
                                            </div>
                                        </div>
...
if(isset($_POST['submit']))
{
    ...
    if(in_array($filecheck,$validImageExtension)){
...
$sql1="insert into LMS.book (Title,Publisher,Year,Availability,Image) values ('$title','$publisher','$year','$availability','$destinationfile')";
