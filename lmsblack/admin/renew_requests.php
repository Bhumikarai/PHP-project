                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select * from LMS.record,LMS.book,LMS.renew where renew.BookId=book.BookId and renew.Pin=record.Pin and renew.BookId=record.BookId";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($renewals > 0)
                                        {echo "<a href=\"acceptrenewal.php?id1=".$bookid."&id2=".$pin."\" class=\"btn btn-success\">Accept</a>";}
                                         ?>
                                        <!--a href="rejectrenewal.php?id1=<?php echo $bookid; ?>&id2=<?php echo $pin; ?>" class="btn btn-danger">Reject</a-->
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
