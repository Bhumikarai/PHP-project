                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Rollno"><b>Receiver Pin No:</b></label>
                                            <div class="controls">
                                                <input type="text" id="Pin" name="Pin" placeholder="Pin" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
$sql1="insert into LMS.message (Pin,Msg,Date,Time) values ('$pin','$message',curdate(),curtime())";
