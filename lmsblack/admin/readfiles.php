...
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    <div class="span3">
                     ...
                     <div class="span9" style="background-color:#ffff;" >
                        <form class="form-horizontal row-fluid" action="readfiles.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search"><b>Search:</b></label>
                                            <div class="controls">
                                                <input type="text" id="name" name="name" placeholder="Enter Name/ID of video" class="span8" required>
	...
	<?php
		...
		while ($row = mysqli_fetch_assoc($query_run)) {
			...
			echo "<div class style ='float:left;margin-right:30px; padding-left:5rem;'>
