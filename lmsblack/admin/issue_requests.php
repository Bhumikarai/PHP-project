            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <h1 style="margin: 20px;color:#171c24;"><center>Issue Requests</center></h1>
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        <?php
                                        if($avail > 0)
                                        {echo "<a href=\"accept.php?id1=".$bookid."&id2=".$pin."\" class=\"btn btn-success\">Accept</a>";}
                                         ?>
                                        <a href="reject.php?id1=<?php echo $bookid ?>&id2=<?php echo $pin ?>" class="btn btn-danger">Reject</a>
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
