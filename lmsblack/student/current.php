    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div class="sidebar" style="background-color:#274728; height:400px;margin-bottom: 20px;">
                            <div class="bar" style="background-color:#D6AD60; height:350px; margin-bottom: 20px; margin-top: 50px;">
                               <center> <p style="font-size: 15px; padding-top:20px; font-family: sans-serif; color: #fff">Check Your History Page.</p></center>
                               <div class="innerbar" style="background-color:#fff; padding: 10px; margin-left: 6px;margin-right: 6px; height: 270px; border-radius: 5px; border: 2px solid #fff;">
                                <div class="img">
                                    <img src="img/f77.jpg" style="height: 260px;" >
                                </div>
                               </div>
                            </div>                          
                        </div>
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.record,LMS.book where Pin = '$pin' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";

                                        }
                                    else
                                        $sql="select * from LMS.record,LMS.book where Pin = '$pin' and Date_of_Issue is NOT NULL and Date_of_Return is NULL and book.Bookid = record.BookId";
